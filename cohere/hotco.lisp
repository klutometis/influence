   ...
   *all-units*
   ...
   ; In the original HOTCO, activations influenced valences but not vice
   versa.
   ; In HOTCO, valences can influence activations for a special subset of
   units
   ...
   ; UPDATE-EVAL-ACTIVN updates the activation of an evaluation unit based on
   the
